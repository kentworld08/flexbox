              ...
              {infiniteLogos.map((logo, index) => (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-gray-600 transition-all duration-300 group-hover:scale-110 group-hover:bg-gray-800/80">
                      <img
                        src={logo.url || "/placeholder.svg"}
                        alt={`${logo.name} logo`}
                        className="w-36 h-20 object-contain filter brightness-90 group-hover:brightness-110 transition-all duration-300"
                      />
                    </div>
                  </div>
                </div>
                ...
                .map((logo, index) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-800/60 hover:border-gray-600 transition-all duration-300 group-hover:scale-105 group-hover:bg-gray-800/60">
                        <img
                          src={logo.url || "/placeholder.svg"}
                          alt={`${logo.name} logo`}
